...
@FacesConverter(forClass = LremapConferenceYears.class, value = "conferenceYearsConverter")
public class ConferenceYearsConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        ...
        if (value != null && !value.isEmpty()) {
            try {
                ...
                LremapConferenceYears ret = service.findLremapConferenceYears(Integer.parseInt(value));
                return ret;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        ...
        if (object != null && !(object instanceof String)) {
            ...
            LremapConferenceYears ret = (LremapConferenceYears) object;
            if (ret.getId() != null) {
