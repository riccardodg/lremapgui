...
@FacesConverter(forClass = LremapSideTableStatus.class, value = "statusConverter")
public class StatusConverter implements Converter {
    ...
    public Object getAsObject(FacesContext fc, UIComponent uic, String value) {
        ...
        if (value != null && !value.isEmpty()) {
            try {
                ...
                LremapSideTableStatus ret = service.findLremapSideStatus(Integer.parseInt(value));
                return ret;
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object object) {
        ...
        if (object != null && !(object instanceof String)) {
            ...
            LremapSideTableStatus ret = (LremapSideTableStatus) object;
            if (ret.getId() != null) {
